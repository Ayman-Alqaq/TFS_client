...
local potions = {
	...
	[26029] = {mana = {875, 1125}, vocations = {1, 2, 5, 6}, level = 180, flask = 7635,
			description = "Only druids and sorcerers of level 180 or above may drink this fluid."},

	[26030] = {health = {440, 580}, mana = {440, 580}, vocations = {3, 7}, level = 180, flask = 7635,
			description = "Only paladins of level 180 or above may drink this fluid."},

	[26031] = {health = {875, 1125}, vocations = {4, 8}, level = 180, flask = 7635,
			description = "Only knights of level 180 or above may drink this fluid."}
}
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if potion.health or potion.mana or potion.combat then
		...
		player:removeItem(potion.flask, 1)
		player:addItem(2148, 5)
	end
