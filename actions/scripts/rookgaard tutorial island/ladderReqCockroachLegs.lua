function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.uid == 50083 then
		if player:getItemCount(8710) < 3 then
			...
			player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "You still need to kill at least 3 cockroaches and bring their legs to Santiago. Don't give up! Richt click on a corpse and select \"Use\" to open it. You'll find loot in most corpses.")
			return true
		end
