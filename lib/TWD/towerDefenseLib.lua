...
function sendReward(cid)
	...
	player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "You have won the Tower Defense Event.")
...
local function monsterWalkTo(monster, currentDirection) -- Limos - Rewritten entirely by Vanderlay
