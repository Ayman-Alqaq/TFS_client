...
--<]]
    ...
    --<]] 
            msg_call = 'Team Battle will begin in %s! Write "!teambattle" and head to the world event waiting room (Teleport is located in Thais Temple) to join the event.',
            msg_join = '[Team Battle] %s has joined the event.',
            msg_cancel = '[Team Battle] Event has been cancelled due to insufficient players.',
    ...
    --<]]
            ...
            arena = {from = Position(33444, 32160, 7), to = Position(33501, 32213, 7)},
    -->[[ 
        --> FUNCTIONS
    --<]]           
