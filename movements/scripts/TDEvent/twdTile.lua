...
function onStepIn(cid, item, position, fromPosition)
        ...
        if item.uid == 3333 then
                ...
                if not player then -- Make sure that the players exist in the arena, to prevent errors
                        return true
                end
                ...
                -- if getWaveLevel() > 0 then
                        ...
                        -- creature:sendTextMessage(MESSAGE_INFO_DESCR, "There is already someone in the event area. Please wait...")
                        -- return true
                -- end
                ...
                -- Send Messages
                creature:sendTextMessage(MESSAGE_STATUS_CONSOLE_BLUE, "You have a total of ".. creature:getCoins() .." coins.")
                ...
                creature:sendTextMessage(MESSAGE_STATUS_CONSOLE_ORANGE, "The blue arrow points to where the monsters will spawn. Use the hammer to build your first turret.")
