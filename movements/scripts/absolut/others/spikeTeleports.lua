local config = {
	...
	[4228] = {level = {1, 100000}, destination = Position(32228, 32596, 8)},
	[4229] = {destination = Position(32237, 32605, 8)},
	[4230] = {level = {1, 100000}, destination = Position(32243, 32619, 9)},
	[4231] = {destination = Position(32237, 32605, 9)},
	[4232] = {level = {1, 100000}, destination = Position(32240, 32620, 10)},
	[4233] = {destination = Position(32237, 32605, 10)},
	[4234] = {level = {1, 100000}, destination = Position(32227, 32598, 11)},
	[4235] = {destination = Position(32237, 32605, 11)},
	[4236] = {level = {1, 100000}, destination = Position(32238, 32622, 12)},
	[4237] = {destination = Position(32237, 32605, 12)},
	[4238] = {level = 0, destination = Position(32244, 32619, 13)},
	[4239] = {destination = Position(32237, 32605, 13)},
	[4240] = {level = 0, destination = Position(32244, 32588, 14)},
	[4241] = {destination = Position(32237, 32605, 14)},
	[4242] = {level = 0, destination = Position(32224, 32606, 15)},
