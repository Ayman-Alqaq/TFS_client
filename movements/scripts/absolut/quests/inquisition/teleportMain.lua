local teleports = {
	[2150] = {text = 'Entering Ushuriel\'s ward.', newPos = Position(33158, 31728, 11)}, -- to ushuriel ward
	[2151] = {text = 'Entering the Crystal Caves.', newPos = Position(33069, 31782, 13)}, -- from ushuriel ward
	[2152] = {text = 'Escaping back to the Retreat.', newPos = Position(33165, 31709, 14)}, -- from crystal caves
	[2153] = {text = 'Entering the Crystal Caves.', newPos = Position(33069, 31782, 13)}, -- to crystal caves
	...
	[2157] = {text = 'Entering the Blood Halls.', newPos = Position(33372, 31613, 14)}, -- from zugurosh ward
	[2158] = {text = 'Escaping back to the Retreat.', newPos = Position(33165, 31709, 14)}, -- from blood halls
	[2159] = {text = 'Entering the Blood Halls.', newPos = Position(33372, 31613, 14)}, -- to blood halls
	...
	[2162] = {text = 'Entering the Vats.', newPos = Position(33153, 31782, 12)}, -- from madareth ward
	[2163] = {text = 'Escaping back to the Retreat.', newPos = Position(33165, 31709, 14)}, -- from vats
	[2164] = {text = 'Entering the Vats.', newPos = Position(33153, 31782, 12)}, -- to vats
	...
	[2168] = {text = 'Entering the Arcanum.', newPos = Position(33038, 31753, 15)}, -- from demon forge
	[2169] = {text = 'Escaping back to the Retreat.', newPos = Position(33165, 31709, 14)}, -- from arcanum
	[2170] = {text = 'Entering the Arcanum.', newPos = Position(33038, 31753, 15)}, -- to arcanum
	...
	[2173] = {text = 'Entering Annihilon\'s ward.', newPos = Position(33197, 31703, 11)}, -- to annihilon ward
	[2174] = {text = 'Entering the Hive.', newPos = Position(33199, 31686, 12)}, -- from annihilon ward
	[2175] = {text = 'Escaping back to the Retreat.', newPos = Position(33165, 31709, 14)}, -- from hive
	[2176] = {text = 'Entering the Hive.', newPos = Position(33199, 31686, 12)}, -- to hive
	[2177] = {text = 'Entering Hellgorak\'s ward.', newPos = Position(33104, 31734, 11)}, -- to hellgorak ward
	[2178] = {text = 'Entering the Shadow Nexus. Abandon all Hope.', newPos = Position(33110, 31682, 12)}, -- from hellgorak ward
