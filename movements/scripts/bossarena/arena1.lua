...
local config = {
[64700] = {toPosition = Position(33107, 31935, 7)}
}
...
function onStepIn(creature, item, position, fromPosition)
	...
	if (player:removeItem(2157, 1)) then
	    if player:getStorageValue(1) and not isPlayerInArea({x = 33095, y = 31922, z = 7, stackpos = 255}, {x = 33111, y = 31938, z = 7, stackpos = 255}) then
		player:teleportTo(targetTeleport.toPosition)
	    doSummonCreature("tarbaz", {x = 33100, y = 31929, z = 7})
	else
