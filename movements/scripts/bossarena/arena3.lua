...
local config = {
[64704] = {toPosition = Position(33067, 31962, 7)}
}
...
function onStepIn(creature, item, position, fromPosition)
	...
	if (player:removeItem(2157, 1)) then
	        if player:getStorageValue(1) and not isPlayerInArea({x = 33055, y = 31947, z = 7, stackpos = 255}, {x = 33071, y = 31963, z = 7, stackpos = 255}) then
		player:teleportTo(targetTeleport.toPosition)
	        doSummonCreature("plagirath", {x = 33057, y = 31953, z = 7})
		else
