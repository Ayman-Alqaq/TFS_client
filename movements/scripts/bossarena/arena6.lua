...
local config = {
[64701] = {toPosition = Position(33066, 31935, 7)}
}
...
function onStepIn(creature, item, position, fromPosition)
	...
	if (player:removeItem(2157, 1)) then
	        if player:getStorageValue(1) and not isPlayerInArea({x = 33055, y = 31922, z = 7, stackpos = 255}, {x = 33071, y = 31938, z = 7, stackpos = 255}) then
		player:teleportTo(targetTeleport.toPosition)
	        doSummonCreature("zamulosh", {x = 33059, y = 31928, z = 7})
		else
