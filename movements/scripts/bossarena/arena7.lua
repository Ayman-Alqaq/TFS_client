...
local config = {
[64706] = {toPosition = Position(33066, 31986, 7)}
}
...
function onStepIn(creature, item, position, fromPosition)
	...
	if (player:removeItem(2157, 1)) then
	        if player:getStorageValue(1) and not isPlayerInArea({x = 33055, y = 31972, z = 7, stackpos = 255}, {x = 33071, y = 31988, z = 7, stackpos = 255}) then
		player:teleportTo(targetTeleport.toPosition)
	        doSummonCreature("ragiaz", {x = 33058, y = 31977, z = 7})
		else
