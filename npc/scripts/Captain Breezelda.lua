...
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Venore}, {Trainer}, {Hunter Island}, {Rookgaard Ruins}, {Island of Destruction}, or {Thais}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Venore}, {Trainer}, {Hunter Island}, {Rookgaard Ruins}, {Island of Destruction}, or {Thais}?'})
