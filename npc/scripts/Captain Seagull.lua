...
keywordHandler:addKeyword({'trip'}, StdModule.say, {npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Carlin}, {Venore}, {Yalahar}, {Edron}, {Trainer}, {Hunter Island}, {Rookgaard Ruins}, {Island of Destruction}, or {Gray Island}?"})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Carlin}, {Venore}, {Yalahar}, {Edron}, {Trainer}, {Hunter Island}, {Rookgaard Ruins}, {Island of Destruction}, or {Gray Island}?"})
keywordHandler:addKeyword({'town'}, StdModule.say, {npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Carlin}, {Venore}, {Yalahar}, {Edron}, {Trainer}, {Hunter Island}, {Rookgaard Ruins}, {Island of Destruction}, or {Gray Island}?"})
keywordHandler:addKeyword({'destination'}, StdModule.say, {npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Carlin}, {Venore}, {Yalahar}, {Edron}, {Trainer}, {Hunter Island}, {Rookgaard Ruins}, {Island of Destruction}, or {Gray Island}?"})
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Carlin}, {Venore}, {Yalahar}, {Edron}, {Trainer}, {Hunter Island}, {Rookgaard Ruins}, {Island of Destruction}, or {Gray Island}?"})
keywordHandler:addKeyword({'go'}, StdModule.say, {npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Carlin}, {Venore}, {Yalahar}, {Edron}, {Trainer}, {Hunter Island}, {Rookgaard Ruins}, {Island of Destruction}, or {Gray Island}?"})
