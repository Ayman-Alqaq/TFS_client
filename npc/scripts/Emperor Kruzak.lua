...
-- Promotion
local promoteKeyword = keywordHandler:addKeyword({'promot'}, StdModule.say, {npcHandler = npcHandler, text = 'If you have the required level, simply log out and log back in. You will automatically receive a promotion.'})
