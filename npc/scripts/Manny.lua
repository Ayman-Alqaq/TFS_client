...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'withdraw') then
		...
		elseif getPlayerBalance(cid) == 0 then
			npcHandler:say('You don\'t have any money in your bank account.', cid)
			Topic[cid] = nil
		else
...
keywordHandler:addKeyword({'name'}, StdModule.say, {npcHandler = npcHandler, text = "My name is Manny."})
